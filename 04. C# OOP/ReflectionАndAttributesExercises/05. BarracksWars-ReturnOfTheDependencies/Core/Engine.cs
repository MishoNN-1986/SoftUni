...
namespace _05._BarracksWars_ReturnOfTheDependencies.Core
{
    class Engine : IRunnable
    {
        ...
        private string InterpredCommand(string[] data, string commandName)
        {
            ...
            Type typeOfCommand = Type.GetType("_05._BarracksWars_ReturnOfTheDependencies.Core.Commands." + commandName);
