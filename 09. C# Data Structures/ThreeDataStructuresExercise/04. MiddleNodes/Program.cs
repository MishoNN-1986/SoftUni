...
namespace _04._MiddleNodes
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Tree<int> root = tree.FirstOrDefault(x => x.Value.Parent == null).Value; // намираме корена

            //root.Print();
            List<Tree<int>> middleNodes = tree
                .Values.Where(x => x.Children.Count != 0 && x.Parent != null)
                .ToList();
