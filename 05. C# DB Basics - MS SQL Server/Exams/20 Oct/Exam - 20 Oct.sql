...
SELECT TOP(5) c.[Name] AS CategoryName, COUNT(c.Id) AS ReportsNumber
...
SELECT e.FirstName + ' ' + e.LastName AS FullName, COUNT(DISTINCT UserId) AS UserCount  
FROM Reports AS r
...
ON u.Id = r.UserId
ORDER BY e.FirstName DESC, e.LastName DESC, dep.[Name], cat.[Name], r.[Description],
r.OpenDate, st.[Label], u.[Name]
